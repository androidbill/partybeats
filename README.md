...
PartyBeats is a Firebase-backed PWA for party music rooms. Google-authenticated users can create or join rooms. Anonymous nickname users can join rooms only. Room admins control the YouTube player and queue; non-admins can add YouTube songs every 3 minutes; everyone can react to queued songs with emojis.
...
1. Go to [Firebase Console](https://console.firebase.google.com/) and create a project named `PartyBeats`.
...
You can paste YouTube URLs without any extra setup. To search YouTube inside PartyBeats:

1. Open [Google Cloud Console](https://console.cloud.google.com/).
2. Select the same project or create one for PartyBeats.
